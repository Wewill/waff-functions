...
class partners_colorize {
	...
	public function apply_colorize($file_path, $file_url) {
...
//			$clut->writeImage('clut.png');
	...
	public function load($file_path) {
		if (!extension_loaded('imagick'))
			wp_die('ERROR : Colorize functions > imagick not installed');

		$im = new Imagick($file_path);
		return $im;	
	}	

	public function createClut($device) {
		if (!extension_loaded('imagick'))
			wp_die('ERROR : Colorize functions > imagick not installed');
